...
\usepackage{multicol}
\usepackage{fontspec}
\setmonofont{Fira Mono} % Intel One Mono
% \usepackage{systeme}
...
\author{
	Andre Santos Felix\qquad\and\qquad
...
\date{8 de septiembre del 2023} % \today

\titlegraphic{
	\begin{picture}(0,0)
		\put(-130,80){\makebox(0,0)[rt]{\href{https://www.overleaf.com/read/mtyfbdhhmpjn}{\includegraphics[width=2.5cm]{overleaf}}}}
